...
################################################################################################
        for line in open(f_data_list, "r"):
            ...
            img = os.path.join(data_root, 'leftImg8bit/' + comp_path + '_leftImg8bit.png')
            label = os.path.join(data_root, "gtFine/" + comp_path + "_gtFine_labelTrainIds.png")
